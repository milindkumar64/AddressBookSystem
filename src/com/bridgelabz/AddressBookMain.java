...
public class AddressBookMain {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * book.getContactDetails(); addressBook.displayContact();
		 * 
		 ...
		 * 
		 * 
		 * while (check.equals("Yes")) { System.out.println("Adding a New Contact : ");
		 * addressBook.addContactDetails(); addressBook.displayContact(); System.out.
		 * println("If want to add more Contacts put 'Yes' else 'No' or AnyKey");
		 * Scanner sc = new Scanner(System.in); check = sc.nextLine(); }
		 */
